# main.py (VERSÃO SÍNCRONA FINAL E CORRIGIDA)
import os
import json
import logging
import pytz
...
def vivi_webhook(request):
    """
    Ponto de entrada principal para TODAS as chamadas do Dialogflow.
    Processa a lógica de forma síncrona.
    """
    ...
    if tag == 'identificar_cliente':
        ...
        if 200 <= status_code < 300:
            ...
            texto_resposta = "Consegui coletar todas as informações, mas tive um problema ao registrar sua solicitação em nosso sistema. Nossa equipe humana já foi notificada."
